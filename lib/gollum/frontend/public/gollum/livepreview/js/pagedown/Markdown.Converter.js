    ...
    Markdown.Converter = function () {
        ...
        function _DoAnchors(text) {
            ...
            */
            ...
            // russ: hacking this so that we can livepreview gollum links
            text = text.replace(/(\[\[([^\[\]\|]+)()\]\])/g, writeGollumPageLink);
            text = text.replace(/(\[\[([^\[\]\|]+)(\|[^\[\]]*)\]\])/g, writeGollumPageLink);

            return text;
        }

        function writeGollumPageLink(wholeMatch, m1, m2, m3) {
            if ( !m3 )
                m3 = m2;
            else
                m3 = m3.substring(1);
            return writeAnchorTag(wholeMatch, m1, m2, "", m3, "", "", "");
        }
